                    ...
                    <asp:UpdateProgress ID="uprgEmailTest" runat="server" AssociatedUpdatePanelID="upGlobal">
                        <ProgressTemplate>
                            <div class="update-progress">
                                <img src="~/images/animi/BlueArrowsUpdate.gif" alt="Sending..." width="16" height="16" />Sending...
                            </div>
                        </ProgressTemplate>
                    </asp:UpdateProgress>
            ...
            <ajax:TabPanel ID="TabDiag" runat="server" HeaderText="🧪 Diagnostics">
                <ContentTemplate>
                    <asp:UpdateProgress ID="uprgEmailDiag" runat="server" AssociatedUpdatePanelID="upDiag">
                        <ProgressTemplate>
                            <img src="../images/animi/QuaffeeProgress.gif" alt="Testing..." width="16" height="16" />Testing...
                        </ProgressTemplate>
                    </asp:UpdateProgress>
