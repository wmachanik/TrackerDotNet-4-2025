            ...
            if (dataReader != null)
            {
                while (dataReader.Read())
                    allCustomers.Add(new CustomerData()
                    {
                        ...
                        EquipType = dataReader["EquipType"] == DBNull.Value ? 0L : Convert.ToInt32(dataReader["EquipType"]),
                        ...
                        PrefPrepTypeID = dataReader["PrefPrepTypeID"] == DBNull.Value ? 0L : Convert.ToInt32(dataReader["PrefPrepTypeID"]),
                        PrefPackagingID = dataReader["PrefPackagingID"] == DBNull.Value ? 0L : Convert.ToInt32(dataReader["PrefPackagingID"]),
                        SecondaryPreference = dataReader["SecondaryPreference"] == DBNull.Value ? 0L : Convert.ToInt32(dataReader["SecondaryPreference"]),
                        ...
                        PreferedAgent = dataReader["PreferedAgent"] == DBNull.Value ? 0L : Convert.ToInt32(dataReader["PreferedAgent"]),
                        SalesAgentID = dataReader["SalesAgentID"] == DBNull.Value ? 0L : Convert.ToInt32(dataReader["SalesAgentID"]),
