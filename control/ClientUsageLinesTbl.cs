    ...
    if (dataReader != null)
    {
      while (dataReader.Read())
        clientUsageLinesTbl.Add(new ClientUsageLinesTbl()
        {
          ...
          CupCount = dataReader["CupCount"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CupCount"]),
    ...
    string pSortBy)
  {
    ...
    if (dataReader != null)
    {
      while (dataReader.Read())
      {
        ...
        clientUsageLinesTbl.CupCount = dataReader["CupCount"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CupCount"]);
  ...
  public ClientUsageLinesTbl GetLatestUsageData(long pCustomerID, int pServiceTypeID)
  {
    ...
    if (dataReader != null)
    {
      if (dataReader.Read())
      {
        ...
        latestUsageData.CupCount = dataReader["CupCount"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CupCount"]);
