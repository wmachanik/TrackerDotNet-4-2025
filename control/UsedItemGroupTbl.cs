...
public class UsedItemGroupTbl
{
  ...
  public UsedItemGroupTbl()
  {
    ...
    this._LastItemDateChanged = DateTime.Now.Date;
    ...
    if (dataReader != null)
    {
      while (dataReader.Read())
        all.Add(new UsedItemGroupTbl()
        {
          ...
          ContactID = dataReader["ContactID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["ContactID"]),
          ...
          LastItemDateChanged = dataReader["LastItemDateChanged"] == DBNull.Value ? DateTime.Now : Convert.ToDateTime(dataReader["LastItemDateChanged"]),
  ...
  public UsedItemGroupTbl ContactLastGroupItem(long pContactID, int pGroupItemTypeID)
  {
    ...
    if (dataReader != null)
    {
      if (dataReader.Read())
      {
        ...
        usedItemGroupTbl.LastItemDateChanged = dataReader["LastItemDateChanged"] == DBNull.Value ? DateTime.Now : Convert.ToDateTime(dataReader["LastItemDateChanged"]);
