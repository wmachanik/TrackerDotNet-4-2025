  ...
  public List<ReoccuringOrderExtData> GetAll(int IsEnabled, string SortBy, string WhereFilter)
  {
    ...
    if (dataReader != null)
    {
      while (dataReader.Read())
      {
        ...
        reoccuringOrderExtData.ReoccuringOrderID = dataReader["ID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["ID"]);
        reoccuringOrderExtData.CustomerID = dataReader["CustomerID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CustomerID"]);
        ...
        reoccuringOrderExtData.NextDateRequired = dataReader["NextDateRequired"] == DBNull.Value ? DateTime.Now.Date : Convert.ToDateTime(dataReader["NextDateRequired"]).Date;
  ...
  public ReoccuringOrderTbl GetByReoccuringOrderByID(long pReoccuringID)
  {
    ...
    if (dataReader != null)
    {
      if (dataReader.Read())
      {
        ...
        reoccuringOrderById.CustomerID = dataReader["CustomerID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CustomerID"]);
        ...
        reoccuringOrderById.NextDateRequired = dataReader["NextDateRequired"] == DBNull.Value ? DateTime.Now.Date : Convert.ToDateTime(dataReader["NextDateRequired"]).Date;
