...
namespace TrackerDotNet.DataSets.CustomersDataSetTableAdapters
{
    ...
    public partial class CustomersTableAdapter : Component
    {
        ...
        // Fix for CS0229: Ambiguity between 'CustomersTableAdapter.ClearBeforeFill' and 'CustomersTableAdapter.ClearBeforeFill'

        // The issue is likely caused by duplicate definitions of the `ClearBeforeFill` property.
        // To resolve this, ensure that only one definition of the property exists in the class.
