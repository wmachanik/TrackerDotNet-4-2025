          ...
          DateTime pEndDate)
        {
            ...
            if (dataReader != null)
            {
                while (dataReader.Read())
                {
                    ...
                    orderCheckData.OrderID = dataReader["OrderID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["OrderID"]);
                    orderCheckData.CustomerID = dataReader["CustomerID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CustomerID"]);
