        ...
        public static List<CustomerData> GetAllCustomers(string SortBy)
        {
            ...
            if (dataReader != null)
            {
                while (dataReader.Read())
                    ...
                    {
                        CustomerID = Convert.ToInt64(dataReader["CustomerID"]),
                        ...
                        City = dataReader["City"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["City"]),
                        ...
                        CustomerTypeID = dataReader["CustomerTypeID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CustomerTypeID"]),
                        EquipType = dataReader["EquipType"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["EquipType"]),
                        CoffeePreference = dataReader["CoffeePreference"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CoffeePreference"]),
                        PriPrefQty = dataReader["PriPrefQty"] == DBNull.Value ? 0.0 : Convert.ToDouble(dataReader["PriPrefQty"]),
                        PrefPrepTypeID = dataReader["PrefPrepTypeID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["PrefPrepTypeID"]),
                        PrefPackagingID = dataReader["PrefPackagingID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["PrefPackagingID"]),
                        SecondaryPreference = dataReader["SecondaryPreference"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["SecondaryPreference"]),
                        ...
                        PreferedAgent = dataReader["PreferedAgent"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["PreferedAgent"]),
                        SalesAgentID = dataReader["SalesAgentID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["SalesAgentID"]),
