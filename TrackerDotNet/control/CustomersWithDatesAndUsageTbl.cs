        ...
        public CustomersWithDatesAndUsageTbl GetCustomerWithDatesAndUsage(long pCustomerID)
        {
            ...
            if (dataReader != null)
            {
                if (dataReader.Read())
                {
                    ...
                    withDatesAndUsage.Customer.CustomerID = dataReader["CustomerID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CustomerID"]);
                    ...
                    withDatesAndUsage.NextRoastDateByCity.CityID = dataReader["CityID"] == DBNull.Value ? 0L : (long)Convert.ToInt32(dataReader["CityID"]);
