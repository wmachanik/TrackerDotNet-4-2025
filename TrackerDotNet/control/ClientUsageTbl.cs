...
namespace TrackerDotNet.control
{
    ...
    public class ClientUsageTbl
    {
        ...
        public ClientUsageTbl()
        {
            ...
            this._NextDescaleEst = DateTime.Now.Date;
            this._NextServiceEst = DateTime.Now.Date;
        ...
        public ClientUsageTbl GetUsageData(long pCustomerID)
        {
            ...
            if (dataReader != null)
            {
                if (dataReader.Read())
                {
                    ...
                    usageData.NextDescaleEst = dataReader["NextDescaleEst"] == DBNull.Value ? DateTime.Now.Date : Convert.ToDateTime(dataReader["NextDescaleEst"]).Date;
                    usageData.NextServiceEst = dataReader["NextServiceEst"] == DBNull.Value ? DateTime.Now.Date : Convert.ToDateTime(dataReader["NextServiceEst"]).Date;
