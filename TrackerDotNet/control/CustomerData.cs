...
namespace TrackerDotNet.control
{
    ...
    public class CustomerData
    {
        ...
        private long _EquipType;
        private long _CoffeePreference;
        private double _PriPrefQty;
        private long _PrefPrepTypeID;
        private long _PrefPackagingID;
        private long _SecondaryPreference;
        private double _SecPrefQty;
        private bool _TypicallySecToo;
        private long _PreferedAgent;
        private long _SalesAgentID;
        ...
        public CustomerData()
        {
            ...
            this._CustomerTypeID = this._EquipType = this._CoffeePreference = 0L;
            this._PriPrefQty = 0.0;
            this._PrefPrepTypeID = this._PrefPackagingID = this._SecondaryPreference = 0L;
            this._SecPrefQty = 0.0;
            this._TypicallySecToo = false;
            this._PreferedAgent = this._SalesAgentID = 0L;
            this._MachineSN = "";
