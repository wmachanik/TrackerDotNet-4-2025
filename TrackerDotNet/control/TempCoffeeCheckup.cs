        ...
        public List<ContactToRemindDetails> GetAllContacts(string SortBy)
        {
            ...
            if (dataReader != null)
            {
                while (dataReader.Read())
                    ...
                    {
                        TCCID = dataReader["TCCID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["TCCID"]),
                        CustomerID = dataReader["CustomerID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CustomerID"]),
            ...
            if (CustomerID > 0L)
            {
                ...
                if (dataReader != null)
                {
                    while (dataReader.Read())
                    {
                        ...
                        {
                            TCIID = dataReader["TCIID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["TCIID"]),
                            CustomerID = dataReader[nameof(CustomerID)] == DBNull.Value ? 0L : Convert.ToInt64(dataReader[nameof(CustomerID)]),
                            ...
                            ReoccurID = dataReader["ReoccurOrderID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["ReoccurOrderID"])
                        };
        ...
        public List<ContactToRemindWithItems> GetAllContactAndItems(string SortBy)
        {
            ...
            if (dataReader != null)
            {
                while (dataReader.Read())
                {
                    ...
                    toRemindWithItems.TCCID = dataReader["TCCID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["TCCID"]);
                    toRemindWithItems.CustomerID = dataReader["CustomerID"] == DBNull.Value ? 0L : Convert.ToInt64(dataReader["CustomerID"]);
