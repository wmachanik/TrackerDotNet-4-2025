...
namespace TrackerDotNet.control
{
    ...
    public class SendCheckEmailTextsData
    {
        ...
        public SendCheckEmailTextsData()
        {
            ...
            this._DateLastChange = DateTime.Now.Date;
        ...
        public SendCheckEmailTextsData GetTexts()
        {
            ...
            if (dataReader != null)
            {
                if (dataReader.Read())
                {
                    ...
                    texts.DateLastChange = dataReader["DateLastChange"] == DBNull.Value ? DateTime.Now.Date : Convert.ToDateTime(dataReader["DateLastChange"]).Date;
        ...
        public string UpdateTexts(SendCheckEmailTextsData pEmailTextsData, int pOriginalID)
        {
            ...
            trackerDb.AddParams((object)DateTime.Now.Date, DbType.Date, "@DateLastChange");
