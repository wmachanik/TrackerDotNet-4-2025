...
namespace TrackerDotNet.control
{
    ...
    public class DeliveryItemsTbl
    {
        ...
        private long _otCompanyId;
        private long _otItemTypeID;
        private long _itReplacementID;
        ...
        {
            this._otOrderID = this._otCompanyId = this._otItemTypeID = this._itReplacementID = 0L;
            ...
            this._otOrderDate = this._otRoastDate = this._otRequiredDate = DateTime.Now.Date;
            this._itItemEnabled = this._otConfirmed = true;
            this._otDone = false;
        }

        public long otOrderID
        {
            get => this._otOrderID;
            set => this._otOrderID = value;
        }

        public long otCompanyId
        {
            get => this._otCompanyId;
            set => this._otCompanyId = value;
        }

        public long otItemTypeID
        {
            get => this._otItemTypeID;
            set => this._otItemTypeID = value;
        }

        public long itReplacementID
        {
