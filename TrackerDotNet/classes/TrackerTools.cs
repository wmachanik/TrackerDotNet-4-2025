...
namespace TrackerDotNet.classes
{
    ...
    public class TrackerTools
    {
          ...
          TrackerTools.PrepAndDeliveryData pNextPrepAndDeliveryData)
        {
            ...
            pNextRoastCityTbl.CityID = (long)pCityID;
            ...
            IDataReader dataReader = trackerDb.ExecuteSQLGetDataReader("SELECT CityID FROM NextRoastDateByCityTbl WHERE CityID = " + (object)pCityID);
            string str;
            if (dataReader != null && dataReader.Read())
            {
      ...
      new DBParameter()
      {
        ...
        public TrackerTools.ContactPreferedItems RetrieveCustomerPrefs(long _CustID)
        {
            ...
            if (dataReader != null)
            {
                if (dataReader.Read())
                {
                    contactPreferedItems.DeliveryByID = dataReader["PreferedAgent"] == DBNull.Value ? 3 : (int)dataReader["PreferedAgent"];
                    ...
                    contactPreferedItems.RequiresPurchOrder = dataReader["RequiresPurchOrder"] != DBNull.Value && (bool)dataReader["RequiresPurchOrder"];
                }
                dataReader.Close();
            }
            trackerDb.Close();
        ...
        public class ContactPreferedItems
        {
            ...
            {
                get => this._DeliveryByID;
                set => this._DeliveryByID = value;
            }
