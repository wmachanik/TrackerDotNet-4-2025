<%@ Page Title="Order Done" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OrderDone.aspx.cs" 
...
<asp:Content ID="cntOrderDoneBdy" ContentPlaceHolderID="MainContent" runat="server">
  <ajaxToolkit:ToolkitScriptManager ID="smOrderDone" runat="server" />
  <h2 class="InputFrm">
    Order Delivered</h2>
