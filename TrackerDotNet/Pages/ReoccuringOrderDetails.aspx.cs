...
namespace TrackerDotNet.Pages
{
    ...
    public class ReoccuringOrderDetails : Page
    {
        ...
        protected ToolkitScriptManager smReoccuringOrderDetails;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.PutDataFromForm(Convert.ToInt64(this.Request.QueryString["ID"]));
            }
            else
            {
        ...
        private ReoccuringOrderTbl GetDataFromForm()
        {
            ...
            if (!string.IsNullOrEmpty(this.ReoccuringOrderIDLabel.Text))
                dataFromForm.ReoccuringOrderID = Convert.ToInt64(this.ReoccuringOrderIDLabel.Text);
            dataFromForm.CustomerID = Convert.ToInt64(this.ddlCompanyName.SelectedValue);
        ...
        {
            string str = new ReoccuringOrderDAL().UpdateReoccuringOrder(this.GetDataFromForm(), Convert.ToInt64(this.ReoccuringOrderIDLabel.Text));
        ...
        {
            string str = new ReoccuringOrderDAL().DeleteReoccuringOrder(Convert.ToInt64(this.ReoccuringOrderIDLabel.Text));
