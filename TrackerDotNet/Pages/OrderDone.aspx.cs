...
namespace TrackerDotNet.Pages
{
    ...
    {
        protected ToolkitScriptManager smOrderDone;
        ...
        private long AddItemsToClientUsageTbl(
          long pCustomerID,
          bool pIsActual,
          long pCupCount,
          double pStock,
          DateTime pDeliveryDate)
        {
            ...
            if (pStock > 0.0)
            {
                pCupCount -= Convert.ToInt64(Math.Round(pStock * 100.0, 0));
        ...
        protected void btnDone_Click(object sender, EventArgs e)
        {
            ...
            long int64 = Convert.ToInt64(control1.Text);
            ...
            else
            {
                ...
                if (this.tbxCount.MaxLength > 0)
                    pCupCount = Convert.ToInt64(this.tbxCount.Text);
