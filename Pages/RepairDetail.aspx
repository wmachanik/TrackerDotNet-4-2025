...
<asp:Content ID="cntRepairDetailBdy" ContentPlaceHolderID="MainContent" runat="server">
  <h1>Repair Detail</h1>
  <ajaxToolkit:ToolkitScriptManager runat="server" ID="scrmRepairDetail">
      ...
      <asp:Panel ID="pnlNewRepair" Visible="false" runat="server" >
        ...
        <asp:Panel ID="pnlRepairDetail" runat="server">
          <table cellpadding="0" cellspacing="0" runat="server" class="TblCoffee">
            ...
            <tr>
              <td>Email</td>
              <td><asp:TextBox ID="tbxContactEmail" runat="server" /></td>
            </tr>
            <tr>
              <td>J/C num</td>
              <td><asp:TextBox ID="tbxJobCardNumber" runat="server" /></td>
            </tr>
            <tr>
              <td>Machine Type</td>
              <td>
            ...
            <tr>
              <td>Machine S/N</td>
              <td><asp:TextBox ID="tbxMachineSerialNumber" runat="server" /></td>
            </tr>
            <tr>
              <td>Swop Out?</td>
              <td>
            ...
            <tr style="font-size:x-small">
              <td>ID:<asp:Label ID="lblRepairID" runat="server"/>&nbsp;&nbsp;OID: <asp:Label ID="lblRelatedOrderID" runat="server"/></td>
  ...
  <asp:ObjectDataSource ID="odsCompanyDemos" runat="server" TypeName="TrackerDotNet.control.CompanyNames"
  ...
  <asp:ObjectDataSource ID="odsRepairFaults" runat="server" SelectMethod="GetAll" 
    SortParameterName="SortBy" TypeName="TrackerDotNet.control.RepairFaultsTbl">
    <SelectParameters>
  ...
  <asp:ObjectDataSource ID="odsMachineConditions" runat="server" SortParameterName="SortBy"
    SelectMethod="GetAll" TypeName="TrackerDotNet.control.MachineConditionsTbl">
    <SelectParameters>
