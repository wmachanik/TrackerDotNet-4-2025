...
<!-- ModalPopupExtender -->
        ...
        <asp:UpdatePanel ID="dvCustomersAccInfoUpdatePanel" runat="server" ChildrenAsTriggers="true" UpdateMode="Conditional" >
          <ContentTemplate>
            <table class="TblCoffee" cellpadding="0" cellspacing="0">
              <tr>
                <td>Acc Company Name</td><td><asp:TextBox ID="accFullCoNameTextBox" runat="server" Width="20em" /></td>
                <td>Customer VAT No</td><td><asp:TextBox ID="accCustomerVATNoTextBox" runat="server" Width="15em" /></td>
              </tr>
              <tr>
                ...
                <td colspan="2" align="center">
                  &nbsp;&nbsp;<asp:CheckBox ID="accRequiresPurchOrderCheckBox" runat="server" Text="Requires Purchurse Order" TextAlign="Left" />
              ...
              <tr>
                <td>Accounts First Name</td><td><asp:TextBox ID="accFirstNameTextBox" runat="server" Width="20em" /></td>
                <td>Accounts Last Name</td><td><asp:TextBox ID="accLastNameTextBox" runat="server" Width="20em" /></td>
              </tr>
              <tr>
                <td>Accounts Email</td><td colspan="3"><asp:TextBox ID="accAccEmailTextBox" runat="server" Width="30em" /></td>
              </tr>
              <tr>
                <td>Accounts CC FirstName</td><td><asp:TextBox ID="accAltFirstNameTextBox" runat="server" Width="20em" /></td>
                <td>Accounts CC LastName</td><td><asp:TextBox ID="accAltLastNameTextBox" runat="server" Width="20em" /></td>
              </tr>
              <tr>
                <td>Accounts CC Email</td><td colspan="3"><asp:TextBox ID="accAltEmailTextBox" runat="server" Width="30em" /></td>
              </tr>
              <tr>
                <td>Payment Terms</td>
                <td>
              ...
              <tr>
                <td>Registration No.</td><td><asp:TextBox ID="accRegNoTextBox" runat="server" Width="15em" /></td>
                <td>Limit</td><td><asp:TextBox ID="accLimitTextBox" runat="server" Width="15em" /></td>
              </tr>
              <tr>
                <td>Bank Account No.</td><td><asp:TextBox ID="accBankAccNoTextBox" runat="server" Width="10em" /></td>
                <td>Bank Branch</td><td><asp:TextBox ID="accBankBranchTextBox" runat="server" Width="10em" /></td>
              </tr>
              <tr>
                <td>Accounts Notes</td>
                <td colspan="3"><asp:TextBox ID="accNotesTextBox" runat="server" Width="40em" TextMode="MultiLine" />
                   <asp:Label ID="CustomersAccInfoIDLabel" runat="server" CssClass="small" /> </td>
              </tr>
              <tr>
  ...
  <asp:ObjectDataSource ID="odsInvoiceTypes" runat="server" DataObjectTypeName="TrackerDotNet.control.InvoiceTypeTbl" DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="GetAll" TypeName="TrackerDotNet.control.InvoiceTypeTbl" UpdateMethod="Update">
    <SelectParameters>
      <asp:Parameter DefaultValue="InvoiceTypeDesc" Name="SortBy" Type="String" />
    </SelectParameters>
  </asp:ObjectDataSource>
  <asp:ObjectDataSource ID="odsPaymentTerms" runat="server" DataObjectTypeName="TrackerDotNet.control.PaymentTermsTbl" DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="GetAll" TypeName="TrackerDotNet.control.PaymentTermsTbl" UpdateMethod="Update">
    <SelectParameters>
      <asp:Parameter DefaultValue="PaymentTermDesc" Name="SortBy" Type="String" />
    </SelectParameters>
  </asp:ObjectDataSource>
  <asp:ObjectDataSource ID="odsPriceLevels" runat="server" DataObjectTypeName="TrackerDotNet.control.PriceLevelsTbl" DeleteMethod="Delete" InsertMethod="Insert" SelectMethod="GetAll" TypeName="TrackerDotNet.control.PriceLevelsTbl" UpdateMethod="Update">
    <SelectParameters>
