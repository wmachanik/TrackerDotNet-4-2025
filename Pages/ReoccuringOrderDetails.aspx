...
<asp:Content ID="cntReoccuringOrderDetailsBdy" ContentPlaceHolderID="MainContent" runat="server">
  <h2 class="InputFrm">
    Reoccuring Order Details</h2>
  <asp:Label ID="lblReoccuringOrderID" Visible="false" runat="server" />
  <ajaxToolkit:ToolkitScriptManager ID="smReoccuringOrderDetails" runat="server">
      ...
      <table class="TblMudZebra" cellpadding="0" cellspacing="4" style="font-size:large" >
        <tr>
          ...
          <td colspan="3">
            ...
            <span class="rightColumn small"><asp:Label ID="ReoccuringOrderIDLabel" runat="server" /></span>
          </td>
        </tr>
        <tr>
          <td>Value</td>
          <td><asp:TextBox ID="ValueTextBox" runat="server" Text='<%# Bind("ReoccuranceValue") %>' Width="2em" /></td>
        ...
        <tr>
          ...
          <td><asp:TextBox ID="QuantityTextBox" runat="server" Text='<%# Bind("QtyRequired") %>' /></td>
        </tr>
        <tr>
          <td>Until Date</td>
        ...
        <tr>
          ...
          <td>Enabled</td>
          <td>
            <asp:CheckBox ID="EnabledCheckBox" runat="server" Text="enabled" TextAlign="Right" Checked='<%# Bind("enabled") %>' /><br /><br />
          </td>
        </tr>
        <tr>
          <td>Notes</td>
          ...
          <td style="vertical-align:middle" >
            NextDate: <asp:Label ID="NextDateLabel" runat="server" Text='<%# Bind("NextDateRequired") %>' /></td>
        <tr>
